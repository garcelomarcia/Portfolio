...
export default function Home() {
  ...
  return (
    ...
    <main className="absolute bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40 scroll-smooth lg:w-full">
      <section className="min-h-screen">
        <nav className="py-5 flex justify-between dark:text-white">
          <h1 className="font-burtons text-xl">garcelomarcia</h1>
          <ul className="hidden md:flex items-center space-between">
            <li>
              <a
